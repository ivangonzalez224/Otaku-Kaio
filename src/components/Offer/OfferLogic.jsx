const OfferLogic = () => {
    ...
    return (
      <div className="mainContainer h-screen bg-gray-100 flex justify-center items-center">  
        <div className="offerMain grid grid-cols-3 gap-8 bg-white rounded-md shadow-md w-full md:w-[80%]">
